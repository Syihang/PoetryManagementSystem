...
public class ModifyAdminPasswordDialog extends JDialog {
    public ModifyAdminPasswordDialog(Frame owner, int id) {
        super(owner, "修改管理员密码", true); // true 表示模态对话框
        initDialog(id);
    }
    ...
    private void updatePassword(int id){
        ...
        String oldSurePassword = DataSelece.getPasswordByID(id, false);
        ...
        if (!new1.equals(new2)){
            ...
            DataUpdate.updateAdminPassword(id, new1);
